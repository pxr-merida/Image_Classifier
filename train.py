#RUN script with
#python train.py flowers --gpu --epochs 5 --arch densenet121 --learning_rate 0.001 --hidden_units 500
...
def build_model(arch='densenet121', hidden_units=500, lr=0.001):
...
def mk_checkpoint(model, arch='densenet121', hidden_units=500):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--arch', choices=['densenet121', 'densenet161'],
    ...
    if args.save_dir:
        torch.save(checkpoint, args.save_dir + 'checkpnt.pth')
    else:
        torch.save(checkpoint, 'checkpnt.pth')